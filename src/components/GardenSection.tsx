...
export default function GardenSection() {
  ...
  return (
    <section id="garden" className="relative py-24 bg-[#FCFAF7] text-[#1A2E26] overflow-hidden" aria-label="Our Botanical Gardens">
          ...
          <div className="lg:col-span-6 space-y-8">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-sm bg-[#0F2922]/5 text-[#0F2922] border border-[#0F2922]/10 flex items-center justify-center">
                        <Icon className="w-4.5 h-4.5" />
                      </div>
                      <h4 className="font-serif font-bold text-[#0F2922] text-sm sm:text-base">
                        {feat.title}
                      </h4>
                    </div>
            ...
            <div className="p-5 rounded-sm bg-white border border-zinc-200 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif text-sm font-bold text-[#0F2922]">Seeking Peace?</h4>
                  <p className="text-xs text-zinc-500">Plan a weekend retreat under Satpura valleys.</p>
                </div>
              </div>
              <a
                href="#contact"
                className="px-5 py-2.5 bg-[#0F2922] hover:bg-[#1A382F] text-white rounded-sm text-xs font-bold uppercase tracking-widest transition-colors shadow-sm cursor-pointer"
