...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-24 bg-[#FCFAF7] text-[#1E222F] overflow-hidden" aria-label="Contact and Map">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col justify-between">
            <div className="space-y-6">
              <h3 className="font-serif text-2xl font-bold text-[#0B0F19]">Get In Touch</h3>
              ...
              <div className="space-y-4 font-sans text-xs sm:text-sm">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-sm bg-[#0B0F19]/5 border border-[#0B0F19]/10 text-[#0B0F19] flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-serif font-bold text-[#0B0F19] text-xs sm:text-sm">Hotel Address</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-serif font-bold text-[#0B0F19] text-xs sm:text-sm">Call Center</h4>
                    <p className="text-zinc-500 mt-0.5">Reservations / Inquiries:</p>
                    <a
                      href={`tel:${HOTEL_DETAILS.phone.replace(/\s+/g, '')}`}
                      className="text-[#0B0F19] hover:text-[#D4AF37] font-semibold text-sm mt-0.5 block font-mono"
                    >
                      {HOTEL_DETAILS.phone}
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-serif font-bold text-[#0B0F19] text-xs sm:text-sm">Email Mailbox</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-serif font-bold text-[#0B0F19] text-xs sm:text-sm">Working Hours</h4>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            {submitted ? (
              <div className="p-8 bg-white rounded-sm border border-zinc-200 text-center space-y-4 flex flex-col items-center justify-center h-full shadow-sm">
                <div className="w-12 h-12 rounded-sm bg-[#0B0F19]/5 text-[#0B0F19] border border-[#0B0F19]/10 flex items-center justify-center">
                  <Check className="w-6 h-6" />
                </div>
                <h4 className="font-serif text-xl font-bold text-[#0B0F19]">Message Sent Successfully!</h4>
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-[#0B0F19] hover:bg-[#1C2538] text-white rounded-sm text-xs font-bold uppercase tracking-widest transition-colors cursor-pointer"
              ...
              <form onSubmit={handleSubmit} className="p-6 bg-white rounded-sm border border-zinc-200 space-y-4 shadow-sm">
                <h4 className="font-serif text-lg font-bold text-[#0B0F19]">Send A Direct Message</h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-zinc-200 rounded-sm py-2 px-3 text-xs focus:outline-none focus:border-[#0B0F19] focus:ring-1 focus:ring-[#0B0F19] text-zinc-800 transition-colors"
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-zinc-200 rounded-sm py-2 px-3 text-xs focus:outline-none focus:border-[#0B0F19] focus:ring-1 focus:ring-[#0B0F19] text-zinc-800 transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-[#0B0F19] hover:bg-[#1C2538] text-white font-bold uppercase tracking-widest text-xs rounded-sm flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50"
